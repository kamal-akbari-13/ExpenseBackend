...
public class UserServiceImpl implements UserService {
    ...
    private UserResponseDto userToUserResponseDto(User user) {
        Double totalExpense = transactionRepository.findTotalByUserAndTransactionType(
                user.getId(),
        ...
        Double totalIncome = transactionRepository.findTotalByUserAndTransactionType(
                user.getId(),
        ...
        Long totalTransactions = transactionRepository.findTotalNoOfTransactionsByUser(
                user.getId(), 
                LocalDate.now().getMonthValue(),
                LocalDate.now().getYear()
        );
